...
namespace DaftAppleGames.Common.Books
{
    ...
    public class BookController : MonoBehaviour
    {
        ...
        public bool moveToCameraOnStart;
        ...
        public AudioClip pagesFlippingSound;
        public float pagesFlippingSoundDelay;
        
        [Header("Complex Page Interactions")]
        public PageView[] pageViews;

        [Header("Events")]
        public UnityEvent OnBookFirstOpen;
        public UnityEvent OnBookOpen;
        public UnityEvent OnPageForward;
        public UnityEvent OnPageBackw;
