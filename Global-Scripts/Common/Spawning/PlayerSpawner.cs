...
namespace DaftAppleGames.Common.Spawning
{
    ...
    public class PlayerSpawner : MonoBehaviour
    {
        ...
        [BoxGroup("Player Settings")]
        public Transform playerSpawnTarget;

        [BoxGroup("Respawn Settings")]
        public PlayerRespawnLocation respawnLocation;
        [BoxGroup("Respawn Settings")]
        ...
        [BoxGroup("Delayed Event Settings")]
        public float eventDelay = 5.0f;
        [FoldoutGroup("Delayed Events")]
        public UnityEvent<GameObject> onSpawnDelayEvent;
        ...
        private void Awake()
        {
            ...
            Debug.Log($"Player Spawner Awake: isLoadingFromSave={_isLoadingFromSave}");
            
            if (spawnOnAwake && !_isLoadingFromSave)
            {
                Debug.Log($"Player Spawner Awake: Spawning...");
        ...
        private void Start()
        {
            ...
            Debug.Log($"Player Spawner Start: isLoadingFromSave={_isLoadingFromSave}");
